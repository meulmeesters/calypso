...
(function (calypso) {
    ...
    (function (Services) {
        ...
        var DocumentService = (function () {
            function DocumentService($q, $http, $timeout, $parse, $stateParams, DB, Credentials) {
                this.$q = $q;
                this.$http = $http;
                ...
                var traverse = function (contents, path) {
                    contents.forEach(function (content) {
                        ...
                        if (content.type === 'block') {
                            ...
                            try {
                                var val = self.$parse(currPath)(data);
                                if (val) {
                                    content.value = val;
                                }
                            }
            ...
            DocumentService.prototype.generateJsonDocumentEnvelope = function (document, documentData) {
                ...
                var body = document.contents.reduce(DocumentService.generateJsonBody, (documentData || {})) || {};
