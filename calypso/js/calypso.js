...
(function (calypso) {
    ...
    (function (Directives) {
        ...
        angular.module('calypso.directives').directive('newEntity', [
            ...
            'DB',
            'DocumentService',
            function ($timeout, $rootScope, $parse, $stateParams, EventBus, DB, DocumentService) {
                return {
                    restrict: 'E',
                    scope: {},
...
(function (calypso) {
    ...
    (function (Directives) {
        angular.module('calypso.directives').directive('formToolbar', [
            ...
            'DocumentService',
            'DocumentFilter',
            function ($rootScope, $parse, $state, EventBus, DB, DocumentService, DocumentFilter) {
                return {
                    scope: {
                        document: '=',
                        documentData: '=',
